locals {
    ...
    lambda_name = "astvcc-scheduleLockAndGetVccData"
    lambda_runtime = "java8"
    lambda_handler = "com.traveloka.ast.vcc.lambda.LockAndGetPoolData::execute"
    ...
    rest_api_id = "2ao0eljxdj"
    parent_id = "ulyuw0atfc"
}